        ...
        <div class="dash-content">
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="md:flex-1 bg-white p-6 rounded-lg shadow">
                    <h2 class="text-xl font-bold mb-4">Manage SubCategories</h2>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="bg-gray-50">
                                    ...
                                    <th class="px-4 py-2 text-left text-sm font-medium text-gray-500">Sub Category</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-sm text-gray-700">{{$data1->category_id}}</td>
                                    <td class="px-4 py-2 text-sm text-gray-700">{{$data1->subcategory_name}}</td>
                                    <td class="px-4 py-2 text-sm text-gray-700">
                                        <a href='{{"/admin/edit-subcategory/".$data1->id}}' class="text-blue-600 hover:underline mr-2">Edit</a>
                                        <a href='{{"/admin/delete-subcategory/".$data1->id}}' class="text-red-600 hover:underline mr-2">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
