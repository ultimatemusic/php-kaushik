...
<div class="top">
        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class=" flex justify-center w-full ">
                    <div class="box box1 p-6 rounded-lg shadow-lg text-center bg-blue-400 w-72">
                        ...
                        <span class="text block text-lg font-semibold mb-1">Total FeedBack </span>
            ...
            <div class="activity">
                ...
                <td class="py-2 px-4">{{$data1->user_name}}</td>
                <td class="py-2 px-4 w-1/3">{{$data1->user_email}}</td>
                
                <td class="py-2 px-4">{{$data1->feedback}}</td>
                <td class="py-2 px-4">
                <!-- <a href='{{"/admin/edit-c/".$data1->id}}' class="text-blue-600 hover:underline mr-2">Edit</a> -->

                <a href='{{"/admin/delete-FeedBack/".$data1->id}}' class="text-red-600 hover:underline mr-2" onclick="return confirm('Are you sure to delete data ?')">Delete</button>
                </form>
                </td>
                </tr>
